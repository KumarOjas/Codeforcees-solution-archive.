...
int main(){
  ...
  rem.insert(std::pair<std::string, int>("S", t));
  
  scanf("%d", &t);
  
  rem.insert(std::pair<std::string, int>("M", t));
  
  scanf("%d", &t); 
  
  rem.insert(std::pair<std::string, int>("L", t));
  
  scanf("%d", &t);
  
  
  rem.insert(std::pair<std::string, int>("XL", t));
  
  scanf("%d", &t); 
  
  rem.insert(std::pair<std::string, int>("XXL", t));
